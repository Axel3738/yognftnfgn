...
| Kontot | ✅ Postadress och avsändare sparade 2026-09-25 (mätt i API:t: Sjöhed 160, Harestad, 44274, Sweden). Gatan står med liten bokstav och regionen som "Harestad" — Axel rättar. ⚠️ Adressen är kontoret sedan 2026-09-26 (Stenkolsgatan 1B, 417 07 Göteborg). Kontot `QZ4jLG` är avstängt samma dag (Spoks tog över) och uppdaterades inte — ingen nyckel i sessionen, och inget skickas därifrån. Slås Klaviyo på igen: byt postadressen först. `template-render` fyller inte `organization.full_address`, så sidfoten går inte att mäta den vägen. |
...
| Kvar | Ingenting i Klaviyo. Matstrumpor körs i Spoks sedan 2026-09-26 (`klaviyo/spoks/README.md` → Matstrumpor); Cowork-prompten och sessionsprompten i `SISTA-STEGEN.md` är överspelade. |
