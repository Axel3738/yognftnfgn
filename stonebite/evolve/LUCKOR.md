...
1. **Ägarens dagskort:** MER per verksamhet i rätt valuta, NCPA och vinstbidrag per butik med kursens formel (nettoomsättning − varukostnad − frakt − avgifter − reklam). Svar 1.
   ✅ **1a byggt 2026-09-26:** MER per verksamhet på Översikt (tabell + kortet "MER 7 dagar"), ECB-kurser i hämtningen, Matstrumpors konto läses. ✅ **1b byggt samma dag:** riktig vinst per verksamhet ur Shopifys Cost per item + Shopify Payments avgifter (`kallor/vinst.mjs`). Matstrumpor väntar på Cost per item i Shopify.
2. ✅ **Byggt 2026-09-26 som sidan Laget.** **Creative-tavlan för hela laget:** batcher planerade/klara/försenade, tid brief → live, andel vinnare och breakthroughs, mix nya idéer/iterationer, annonser äldre än 10 dagar utan leverans. Utan kronor. Ur Notion-hubbarna och etiketterna. Svar 3 (D1).
