...
const ORDBOK = {
  ...
  // Korten "AI-boten har svarat" (2026-09-23: ett kort per botsvar, bock, arkiv)
  'AI-boten har svarat': 'The AI bot has replied',
  'Varje kort är ett kundmejl boten redan har svarat på. Läs botens svar innan du skriver, kunden har redan fått det. Bocka av kortet när du följt upp, så hamnar det i arkivet.':
    'Every card is a customer email the bot has already answered. Read the bot\'s reply before you write: the customer already has it. Tick the card when you have followed up and it moves to the archive.',
  'ARG KUND · AI-boten svarade': 'ANGRY CUSTOMER · AI bot replied',
  'AI-boten svarade': 'AI bot replied',
  'Att följa upp': 'To follow up',
  'Boten har lovat kunden något (svar inom 48 timmar, "det tittar vi på direkt") eller lämnat ärendet till dig. Arga kunder överst, äldst först.':
    'The bot promised the customer something (a reply within 48 hours, "we will look at it right away") or handed the case to you. Angry customers on top, oldest first.',
  'Ingenting att följa upp': 'Nothing to follow up',
  'Alla botsvar som lämnats till dig är bockade, eller så har boten inte lämnat något till dig än.': 'Every bot reply handed to you is ticked, or the bot has not handed you anything yet.',
  'Boten svarade klart': 'Fully answered by the bot',
  'Inget att göra om kunden inte skriver igen. Skriver kunden igen: fortsätt tråden, upprepa inte det boten redan sagt.': 'Nothing to do unless the customer writes again. If they do: continue the thread, do not repeat what the bot already said.',
  'Uppföljda (arkiv)': 'Followed up (archive)',
  'Torrkörningens utkast, kunden fick inget': 'Dry-run drafts, the customer got nothing',
  'Markera som uppföljd': 'Mark as followed up',
  'Ångra': 'Undo',
  'Vad boten skrev': 'What the bot wrote',
  'Nästa steg för dig': 'Your next step',
  'Uppföljd av': 'Followed up by',
  'Svar lovat senast': 'Reply promised by',
  'SOP: Följa upp AI-botens svar': 'SOP: Following up the auto-reply',
  'Orsak': 'Reason',
