...
const ORDBOK = {
  ...
  'Läst direkt ur Shopify': 'Read straight from Shopify',
  'Gick inte att läsa': 'Could not be read',
  'Ur kundtjänstens veckorapport.': 'From the weekly customer-service report.',
  'Tvisterna är okända': 'Disputes unknown',
  'Senaste rundan': 'Last run',
  'Vecka': 'Week',
  'i potten': 'at stake',
  ...
  // Autosvaret (kundtjanst/autosvar.mjs) på Kundtjänst och varumärkesfliken
  'Autosvaret': 'Auto-reply bot',
  'Kundtjänstboten som svarar på enkla mejl själv och lugnar arga kunder. De arga hamnar här — VA:n tar över varje ärende i listan.':
    'The support bot that answers simple emails itself and calms angry customers. The angry ones land here — the VA takes over every case in the list.',
  'Autosvaret har inte kört': 'The auto-reply bot has not run',
  'Ingen logg finns för de här butikerna — boten är inte igång här.': 'There is no log for these stores — the bot is not running here.',
  'Ingen logg finns — boten är inte igång för någon butik.': 'There is no log — the bot is not running for any store.',
  'arga kunder': 'angry customers',
  'skickar svar': 'sending replies',
  ...
  'Arga kunder': 'Angry customers',
  'Nyast först. Boten har svarat lugnande — VA:n tar över ärendet och svarar kunden själv.': 'Newest first. The bot sent a calming reply — the VA takes over the case and answers the customer personally.',
  'Butik': 'Store',
  'Vad kunden var arg över': 'What the customer was angry about',
  'Botens svar': "Bot's reply",
  'order saknas i mejlet': 'no order number in the email',
  'skickat': 'sent',
  'utkast — inte skickat': 'draft — not sent',
  'fel': 'failed',
  'inget svar': 'no reply',
  'flaggad': 'flagged',
