...
**Type:** Static in the offer angle, **wide**. One of **four** that run identical copy and differ only in the image.
...
**Changed (isolated variable):** **The image only.** This variant is the wide. Copy, headline, CTA, landing page and ad set are identical across SO_16_1 through SO_16_4. **If any of those differ, the four-way test is void.**
