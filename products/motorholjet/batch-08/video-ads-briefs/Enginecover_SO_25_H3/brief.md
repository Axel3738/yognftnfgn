# Enginecover_SO_25_H3

**VARIABELTAGGAR:** vinkel=`offer/överlager` · hook-typ=`siffra/pris` · format=`video 45-60 s, creator-VSL` · proof=`insider, ingen kund` · offer-i-creativen=`pris nämns (299 mot 367)` · talare=`namngiven insider i bild` · hook=`siffran först`
*(Läses av nästa `/cs` för att gruppera vinstbidrag per variabelvärde. Ändra dem inte utan att ändra creativen.)*

**Type:** Creator-led offer VSL, swipe of a proven ad from another product. **Hook variant: siffran först.**
...
**Vad den här varianten isolerar:** öppningen. **Siffran först.** Priset gör stoppjobbet, utan förklaring.
...
**Hypothesis:** A number does the stopping work on its own, which would make the confession framing unnecessary.
...
|---|---|
| 299 kr. Det är vad ett motorhölje kostar hos Bäverbutiken just nu, 19 procent ner från 367 kr. | 299 kr. That is what a motor cover costs at Bäverbutiken right now, 19 percent down from 367 kr. |
