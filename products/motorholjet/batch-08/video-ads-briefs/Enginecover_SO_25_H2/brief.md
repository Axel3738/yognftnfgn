# Enginecover_SO_25_H2

**VARIABELTAGGAR:** vinkel=`offer/överlager` · hook-typ=`fråga` · format=`video 45-60 s, creator-VSL` · proof=`insider, ingen kund` · offer-i-creativen=`pris nämns (299 mot 367)` · talare=`namngiven insider i bild` · hook=`problem först`
*(Läses av nästa `/cs` för att gruppera vinstbidrag per variabelvärde. Ändra dem inte utan att ändra creativen.)*

**Type:** Creator-led offer VSL, swipe of a proven ad from another product. **Hook variant: problem först.**
...
**Vad den här varianten isolerar:** öppningen. **Problemet först.** Öppnar i igenkänningen i stället för i erbjudandet, vilket kvalificerar publiken innan priset nämns.
...
**Hypothesis:** Opening in the problem qualifies the viewer before the offer arrives, and buys fewer but better clicks than the offer-led opening.
...
|---|---|
| Om du någon gång har sett en presenning blåsa av motorn vid bryggan vet du precis hur irriterande det är. | If you have ever seen a tarp blow off the engine at the dock, you know exactly how annoying that is. |
