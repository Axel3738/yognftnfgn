# Enginecover_SO_25_H1

**VARIABELTAGGAR:** vinkel=`offer/överlager` · hook-typ=`påstående` · format=`video 45-60 s, creator-VSL` · proof=`insider, ingen kund` · offer-i-creativen=`pris nämns (299 mot 367)` · talare=`namngiven insider i bild` · hook=`överlagerbekännelse`
*(Läses av nästa `/cs` för att gruppera vinstbidrag per variabelvärde. Ändra dem inte utan att ändra creativen.)*

**Type:** Creator-led offer VSL, swipe of a proven ad from another product. **Hook variant: överlagerbekännelse.**
...
**Det enda som bevisligen skalar i det här kontot är en kort offer-video.**
...
**Vad den här varianten isolerar:** öppningen. **Originalets vinkel.** Erbjudandet presenteras som konsekvensen av vårt misstag, vilket är det som gör rabatten trovärdig.
...
**Hypothesis:** The overstock confession is what makes the discount credible, and reproduces the original ad's performance in our account.

**Kept:** **Allt från beat 2 och framåt**, byte-identiskt mellan de tre filerna. Och swipens tio beats i sin ordning.

**Changed (isolated variable):** **Öppningen, beat 1, och ingenting annat.**
...
**Ad set:** Motorhölje SO Batch 8 (ABO) — alla tre SO_25-varianter, lika budget
...
|---|---|
| Vi klantade oss och beställde alldeles för många motorhöljen till Bäverbutiken. Nu är lagret proppfullt och du får ett riktigt bra pris. | We messed up and ordered far too many motor covers. Now the warehouse is packed and you get a really good price. |
