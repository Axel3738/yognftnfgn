# Enginecover_SO_21_H4

**VARIABELTAGGAR:** vinkel=`offer/överlager` · hook-typ=`påstående` · format=`video 20 s, creator-UGC` · proof=`egen erfarenhet` · offer-i-creativen=`pris nämns (299 mot 367)` · talare=`creator i bild`
*(Läses av nästa `/cs` för att gruppera vinstbidrag per variabelvärde. Ändra dem inte utan att ändra creativen.)*

**Type:** Video in the offer angle with **a person on camera** — a combination this account has never run.

---

## 🔴 READ THIS FIRST — the campaign is now losing money on new spend
...
## 🔴 Launch structure — this has now failed three times
...
**`Enginecover_SO_4_H1` is the most efficient ad this account has ever run and nobody has ever
touched it.**
...
**Hypothesis:** An offer delivered by a person on camera reaches a different audience than the voiceover version and lands within range of it on profit per krona.

**Kept:** The offer angle, the price proof, the black cover, the length.

**Changed (isolated variable):** **A person on camera** instead of a voiceover over product footage.

> **Do not optimise this for clicks.** Across fifteen judgeable ads, the ads that buy the
> cheapest, most abundant clicks convert the worst. Fewer clicks with a higher add-to-cart rate is
> a better ad.

> **No verdict before 300 kr spend and 3 purchases, and no "winner" call before 2 000 kr.**
...
Captions are **mandatory, burned in, Swedish, word for word** matching the spoken lines. Not
...
**CTA:** Handla nu · **Landing page:** https://baverbutiken.se/products/marin-motorholje-420d-universellt-skydd · **Ad set:** Motorhölje SO Batch 7 (ABO) — all four SO_21 variants, equal budget
...
**Profit per 1 000 kr against `SO_4_H1`'s 1 721** — and against each other. All four must run in
the same ad set with equal budget. No verdict before 300 kr and 3 purchases; no winner call before
2 000 kr. Watch reach and frequency as well: the point of this one is partly to find new people.
