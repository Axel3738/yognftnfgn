# Enginecover_PD_13_H4 — Insurance reframe hook on the winning demo body
...
**Hypothesis:** The insurance reframe (best early ROAS in batch #3 at 9,73 on 36 kr) carries over to the proven body and holds CPA under 96 kr at real spend.
...
**Changed (isolated variable):** ONLY the first 3 seconds. Frames 299 kr as the cheapest protection the engine can get.
...
|---|---|---|---|
| 0:00–0:01,5 | Wide shot: outboard on the transom, water behind | Motorns billigaste försäkring | The engine's cheapest insurance |
| 0:01,5–0:03 | Cut to the cover going on | Bara 299 kr, en gång | Just 299 kr, one time |
...
- Deliver as `Enginecover_PD_13_H4_<length>s.mp4`.
