...
Lagerrensnings-LP (listicle, samma mall som motorhöljets): `lagerrensning/output/axelbalte-for-trimmer-justerbart-nylonbalte/` → blivande `baverbutiken.se/pages/axelbalte-for-trimmer-lagerrensning` när Axel importerat filen i GemPages.
