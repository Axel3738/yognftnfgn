...
**Körning #1** (`/forsta-batch`, 2026-08-21). Datafönster 2026-08-18 19:38 → 2026-08-21 (~2,5 dygn).
...
3 705 kr spend → 33 köp, CPA 112, ROAS 3,93. Vinstbidrag ~5 900 kr / 2,5 dygn. Kampanjen (CBO 4 000 kr/dag) spenderar bara ~1 500 kr/dag — volymen finns inte i auktionen än, headroom både i budget och CPA (×2,5 till break-even).
...
Social proof (SP), gift (GT), väggmonterings-vinkeln, samtliga statics, pris-i-copy (SO 289-versionerna). Testas i batch #2-ABO:t innan någon döms.
...
- **Testa kontrollerat:** captions på råklipp (på/av); situationshook "när det hugger" vs förvaringshook; värde-framing 72 kr/hållare; väggmontering (use-case 2); trasselhärvan som hook-objekt.
