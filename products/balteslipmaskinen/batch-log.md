...
## Batch #8 — 2026-09-25 eftermiddag (`/rond-auto` steg 4b, brief-runda efter 36 nya lärdomar — Axels order "det finns fortfarande inga lediga briefs")

Rundan låg på 0 i morse (0 lärdomar sedan förra batchen). Efter lärdomarna (36 st, 5 bedömbara) stod brieftaket på 37 + 3 namngivna (PD_21_H1, PD_34_H1, PD_35_1). **Två briefer byggda — de två namngivna platserna med en lärdom bakom.** Inte fyra: PD_21_H1 är redan utförd som `Beltgrinder_PD_33_H1` (omdöpt 2026-09-22, ligger i hubben — regel b), PD_19_1:s koncept har tre iterationer utan lärdom (koncept vid taket, punkt 18), alla LOSER/INGEN_LEVERANS-lärdomar slutar i SLÄPP, SP/REV är spärrade av recensionsregeln (citaten är launchimport), BOF kräver en KPI_WINNER bland BOF-etiketterna (0) och GT byggdes 22/9. Kampanjen läst ACTIVE 14:3x UTC (950 kr/dag, ROAS 3d 1,61 mot break-even 1,76 — CPA stiger, nya creatives är fixet). Feedback-raden "Brief review 2026-09-22" läst: ETT break-even (566 kr) i båda, engelska = svenska, sammansättningar ihop; namnen PD_34/PD_35 är lärdomarnas namngivna platser (regel a) och bär förälderns namn i parent-taggen. Priset läst live 2026-09-25: 909 kr / 1 182 kr (spara 273 kr, 23 %). Copy av sonnet, regi av huvudsessionen (PD_1 läst 1 frame/s ur Meta). Spärrar: briefgranskning ✅ 2/2 (regi 9/9), `lardom --brief` ✅ 2 BRIEF-rader. Hub `Belt grinder creative hub`, Status Draft; PD_34_H1 öppnad och kontrollerad — hela briefen står i sidan.

| Annons | Format | Typ | Parent | Variabel | Hypotes | Förväntan | rev | brief → live |
|---|---|---|---|---|---|---|---|---|
| Beltgrinder_PD_34_H1 | video | I | Balteslipmaskin_PD_1 | öppningen 0–2 s: bladet mot bandet med gnistor (PD_1 0:06) i stället för passiva händer; resten ordagrant | den passiva öppningen kostar spend, inte köp (hook 47 %, CVR 2,0 % > top spenderns) | hook rate > 47 %, CPA ≤ 329 kr (förälderns första vecka) mot break-even 566 | okänd | — |
