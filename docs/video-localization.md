...
| NO-batch 2026-09-09, rutinen `/translate-no`: Adventskalender Racingbilar 12 videor + 4 bildannonser | no / Norwegian Bokmål (Norway) | ✅ 2026-09-09 | ✅ 12/12 via sonnet-subagent: HeyGens grovöversättning bar de svenska priserna rakt av (649→579, 499→439 i CS_1–CS_3) och hade feltranskriberat 649 till "Sekstifire ni kroner" · "spar hundre og femti" → "hundre og førti" (verklig differens 140 kr) · räkneordsfel "de tjueandre andre" → "de tjuetre andre" (PD_1, PD_3) · onaturliga futurumformer i G_1–G_3 · regexverifierat grönt (inga SEK-belopp, inga ä/ö), timecodes och blockantal identiska | ✅ 12/12 `no-captions.py` Beltesliper-stilen, automatisk bandmätning per video (1445–1613, källorna har inbränd svensk text med FEL pris: "Idag 649 blir") · skriptets kontroll grön på alla 12 · QA-bilder lästa (CS_1 ×3, G_1, PD_1, SP_1) · slutkortssvep på alla 12 i kontaktark — bara norska captions, ingen svensk domän, inget SEK-pris | ✅ 12 mp4 (12 zip ≤30 MiB) + 4 png i chatten · Drive: MAKE TO NORWAY → "NO Adventskalender Racingbilar" (`15cCTTxEDXNqDDfFu2LGB7XaYT8M-B8vC`, 12 mp4 + 4 png + 4 adcopy-txt) via Google-Drive-connectorn + drive-push.mjs · launchad ACTIVE: "Adventskalender NO \| BE-ROAS 1,62 \| 2026-09-09" (120252140554000233), CBO 1000 kr/dag, 4 adsets (CS/G/PD/SP) × 3 videoannonser + 1 bildannons — API-verifierat: 16 annonser, alla ACTIVE/ACTIVE | ⚠️ **LAUNCHED kraftigt utrensad:** 20 produktmappar 2026-09-07 → 2 st 2026-09-09 (Adventskalender + Pälsborste, den senare redan täckt). Bordtennisnät Infällbart är BORTA ur LAUNCHED — den sex nätter långa COGS-blockeringen är därmed upplöst av sig själv, inget problemmeddelande behövdes · **COGS-docet har ett sjätte batch-sheet** utöver #1–#5.1 (`1zGcVdwHVdvTD3t894FdFw--9fL8B5v5oMH5kK2XWM-I`) — produkten fanns bara där, raden "car racing calendar", NORWAY 15,69 EUR · pris 439 kr (før 579 = 24,18 %), svenska CS-claimet 23 % underdriver → ingen jämförprisändring behövdes · kontot rate-limitat (Meta-fel 17) mitt i launchen: 9 av 12 videoannonser skapades innan skriptet avbröts på SP-adsetet, spärren släppte efter ~2 min och två idempotenta omkörningar la in resten (inget dubbletterades) · **bildannonserna kördes samma natt** (första gången sedan 2026-09-03): Kie rensade bara halva CS-bilden, det röda toppbandet målades över med sin egen färg i stället för en ny Kie-körning · kvot 16 818 → 16 460 |
