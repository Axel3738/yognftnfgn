...
| NO-videobatch 4 Temu-produkter: 47 videor ur Drive (Kranskydd 12 · IBC 11 · Cykelshorts 12 · Bälteslipmaskin 12), rutinen `/translate-no` | no / Norwegian Bokmål (Norway) | ❌ **BLOCKERAD: api-krediterna slut** | ❌ 47 sessioner skapade 2026-08-29, alla failade "Insufficient credit. This operation requires 'api' credits" (api-kvot 11 → 2, plan_credit 1019 hjälper inte API:t) | — | ❌ inget levererat | ⚠️ **proofread kräver api-krediter trots 0 rendering** — kolla `details.api` FÖRE batchstart, failade sessioner bränner ändå kvot · infra klar för omkörning: `pipeline/translate-batch.mjs` + `market-expansion/no/video-batches/2026-08-29/batch.json` (state-fil återskapar failade sessioner) · launchkonfigar klara för Kranbeskyttelse (219/285 NOK, BE-ROAS 1,63) + IBC-tanktrekk (439/571 NOK, BE-ROAS 1,63) · Cykelshorts + Bälteslipmaskin SAKNAS på beverbutikken.no — kan inte launchas · IBC CS_1_H1 saknas i Drive-mappen |
