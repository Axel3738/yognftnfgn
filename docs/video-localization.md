...
| **CaraShell takskyddet → USA** (Axels order 2026-09-16: "Fixa alla till engelska och lägg in dom i den amerikanska kampanjen i Magiborsten UK"): de 12 ärvda SE-videorna `CaraShellRoof_{CS,GT,PD,SP}_{1,2,3}_H1` ur `CARASHELL_SE_Taköverdraget` (OPS-kontot), källor via `act_915422744950975/advideos` på `object_story_spec.video_data.video_id` | US / English (United States) | 12 proofreads + 12 renderingar, **6 849 → 5 997 krediter (852)**, inga omrenderingar | sonnet-SRT mot US-faktalistan: $199/$249/$50 off i ord, free shipping in the US, 90-day guarantee, "RV"/"trailer", "fall"; bort: "bara idag", "medan kampanjen pågår", "14 dagars ångerrätt enligt svensk lag", kronor. `verify-srt.mjs`: byte-identiska timecodes, tempo relativt källblocket (svenskan talar 14–19 tecken/s — absolut tak ljuger) | `no-precis.py` per video (`cap/*.json`, zon 933–1099, piller x 50–670): engelska cues i det svenska pillrets ruta, 91–100 % av frames. **Fem fönster där pillret står mot vit kaross hittades inte** (GT_1 0–0,9 s + slut, GT_2 slut, PD_1/PD_3 "blåser rejält") — svensk text kvar, sedd i frame-QA (`qa/luckor*-ark.png`), löst med `captions.fyll` (manuell vit platta + tvingad caption) och omkörning. Ingen annan inbränd svenska: grafiken "RV ROOF COVER · 5-STAR REVIEW" och "UV-RESISTANT FABRIC" är engelska i källan | 2026-09-16, US-kampanjen `CARASHELL_US_Taköverdrag …` (`120251436741400435`, Magiborsten UK `1107817401910319`, PAUSED utan spend — annonserna ACTIVE inuti), ett adset per koncept; ad-id:n i `products/carashell/takskyddet/batch-log.md` | Röstkoll 12/12 gröna (drift ≤ 1 %, taltapp 0; "sista repliken 0,04–0,12 s från slutet" är en notering, dubben tonar ut). **"Lyssnat" med ElevenLabs Scribe** (`qa/lyssna/scribe.mjs`) på GT_2, PD_2, CS_2, SP_2: 0 tappade ord i GT_2/SP_2, övriga diffar är siffror-som-tal. Samma runda: de 4 ärvda batch #1-bilderna (`_2_1`) på engelska (Kie-rensning + PIL, `rendera-batch1.py`). ffmpeg/Pillow saknades i containern (imageio-ffmpeg + ffprobe-shim) |
