...
| Fiskespöhållare-batch: 15 annonser (Drive-mapp, 5 koncept × 3 hooks) | no + dk + fi + uk (60 översättningar) | ⏸ PAUSAD 2026-08-20 | ⏳ 5/60 transkript klara — api-krediterna tog slut (85→11, ~15 credits/transkribering; ~2 500–3 000 behövs totalt) | — | ❌ inget levererat | Axel valde paus i st.f. påfyllning · **allt state + återupptagningsinstruktion: `docs/source/translate-fiskespohallare-20260820/STATUS.md`** · alla belopp ska strykas · produktnamn: Fiskestangholder/Fiskestangsholder/Kalastusvapateline/Fishing Rod Holder · ⚠️ alla 15 källvideor har inbrända svenska captions → blur-cover + lokaliserade captions krävs på alla 60 |
