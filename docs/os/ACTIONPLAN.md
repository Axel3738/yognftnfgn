...
- **2026-08-05 — LÖST: riktiga break-even-nivåer inne.** Produktsheetets
  kostnadskolumner är fortfarande tomma, men Axel hade COGS-beräkningen på annat
  håll: break-even-ROAS och target-ROAS (25 %) per produkt ligger nu i
  products.json. Mina tidigare härledda break-even låg **28–96 kr för högt** på
  varje produkt — de hade hållit förlustannonser vid liv. Kvarstår: fyll ändå i
  sheetets kostnadskolumner så siffrorna har en källa i systemet.
