# Mastern_GT_310_H1 — It was never the meat — the polite "tasty" at dad's table, and the gift that ends it

**VARIABELTAGGAR:** vinkel=`present / fars dag — smaken (088) från barnets sida` · hook-typ=`föremål (tallriken / slaktarpåsen) + 088-raden` · format=`video, VO + b-roll, 3 hooks` · proof=`mekanismen (gammalt fett värms om, blockerar stekytan) + kundcitat Bertil L.` · offer-i-creativen=`999 kr on the end card only, no percentage` · visuell stil=`tallriken, slaktarpåsen, termometern, springan, lådan, stekytan` · textmängd=`captions word for word, max 8 words per caption` · talare=`dottern — kvinnlig VO` · copy_model=`sonnet` · typ=`I` · koncept=`fd-det-var-aldrig-kottet` · parent=`088` · iteration=`smakskammen sedd av barnet vid bordet, presenten som svaret` · kalla=`parent` · avatar=`vuxet-barn` · awareness=`problem` · begar=`njutning` · mekanism=`det artiga gott (088) → orsaken i springorna → presenten som ger honom reaktionen han jagar` · tro=`pappa gör allt rätt; smaken satt i gallret, och den går att ge tillbaka` · urgency=`sasong` · hook-mekanik=`freeze` · confidence=`medium` · lardom=`L-088`
...
**Why:** 088 is the second most profitable angle in the account and "det artiga gott" is its exact mechanism; the giver has been the one saying it, which makes the gift the end of a small lie rather than a comment on his grill. Judged on purchases and profit contribution, never on ROAS or CTR alone.
**Deliver as:** `Mastern_GT_310_H1`, `Mastern_GT_310_H2`, `Mastern_GT_310_H3` — one file per hook, same body from 0:03.
...
## 2. Hypothesis
The taste angle converts a giver audience when the giver is the one who has been saying "gott" — the shame is shared, the fix is a gift.
**Hook (H1):** «SV H1»
...
| Length | ~31 s. |
| Narrator | Female VO — the daughter. Affectionate, slightly guilty about the "gott". |
...
|---|---|---|
| 0–3 s · HOOK H1 | «SV H1» | «EN H1» — INTENT: Dad blames the meat. It was never the meat. Object: a plate with a half-eaten steak, fork laid down. |
| 0–3 s · HOOK H2 | «SV H2» | «EN H2» — INTENT: We say "gott" every time. The polite gott. Dad hears the difference. Object: the family's hands at the table, a plate passed. |
| 0–3 s · HOOK H3 | «SV H3» | «EN H3» — INTENT: Dad changed butcher three times. The problem sat in the grate. Object: a butcher's paper bag on the counter. |
| 3–8 s · HE DOES EVERYTHING RIGHT | «SV 4» | «EN 4» — INTENT: Good meat from a real butcher. The thermometer. He rests it. He does everything you are supposed to. And there is always something — a taste nobody can place, a sear that never quite comes. |
| 8–14 s · WHERE THE TASTE COMES FROM | «SV 5» | «EN 5» — INTENT: It was never the meat. Grease from the last three years sits in the gaps of the grate. It reheats every time, smokes, and lays itself between the meat and the metal. No contact, no sear. The wire brush never reached it. |
| 14–21 s · THE GIFT + FUNCTION | «SV 6» | «EN 6» — INTENT: So this year: Mastern. One button, the head spins down into the gaps while the grate is still warm, sixty seconds, two heads and nothing comes loose. The box has everything. |
| 21–26 s · NEXT DINNER | «SV 7» | «EN 7» — INTENT: Next dinner nobody says "gott". Somebody asks what he did to the grill. Bertil L. wrote: my arms always ached after a proper clean, now I do it in a minute — verbatim with the name. |
| 26–31 s · LOCK + CTA | «SV 8» | «EN 8» — INTENT: 999 kr, thirty days open purchase, lifetime warranty. Then the giver's line from §6. |
...
**Reference ads:** parent 088 "Förstörd grillkväll" (ROAS 2,32–2,36) — Replicate: "det artiga gott", "det var aldrig köttet", the 101 close ("vad har du gjort med grillen?") / Do not replicate: the male narrator, any 34 % line.
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | 0:00–0:03 (H1) | «SV H1» | VO | «SV H1» | Macro of a plate: a good steak half eaten, the fork laid down beside it, candlelight. **First frame:** the plate with the fork laid down. | freeze 0.5 s then cut-in | NEW FOOTAGE: a plated steak half eaten at a family table, filmed by Axel | — | none |
| 2 | 0:00–0:03 (H2) | «SV H2» | VO | «SV H2» | Macro of hands passing a plate across a set table, a glass raised, faces out of frame. **First frame:** the plate being passed. | cut-in | NEW FOOTAGE: hands at a family dinner table, filmed by Axel or UGC creator Beerhansson | — | none |
| 3 | 0:00–0:03 (H3) | «SV H3» | VO | «SV H3» | Macro of a butcher's paper bag on a kitchen counter, a thermometer beside it. **First frame:** the butcher's bag. | zoom-in 1 s | NEW FOOTAGE: a real butcher's bag and a meat thermometer on a counter, filmed by Axel | — | none |
| 4 | 0:03–0:08 | «SV 4» | VO | «SV 4» | His hands: the thermometer in the meat, the meat resting, the lid opening on a grate that looks clean. | cut-in | DRIVE 1K2B_qE8jVlKng6k1Cpcw_GRsEOXD0aXZ [EDITOR PICKS: thermometer, meat resting, lid opening] | 088 / 101 opening | b-roll order free |
| 5 | 0:08–0:14 | «SV 5» | VO | «SV 5» | Macro: grease smoking in a gap as the grill heats; meat laid on a crusted grate; the wire brush on the top of the bars only. | slow-mo 0.5× 2 s on the smoke | DRIVE 1YY7Y_DuaPAszwF4jM70g0xue1N_hUsq6 [EDITOR PICKS: grease smoking in a gap, wire brush on the top of the bars] | 101 mechanism beat | b-roll order free |
| 6 | 0:14–0:21 | «SV 6» | VO | «SV 6» | The box opened on the kitchen table; his hand on the button; the head spinning in a gap with steam; clean bars. | slow-mo 0.5× 2 s on the spinning head | NEW FOOTAGE: unboxing on a kitchen table, filmed by Axel then DRIVE 1gLEJU2bdzXWU-w2eHoxo9XD2jImMv_Zr [EDITOR PICKS: head spinning in a gap with steam, clean bars] | — | b-roll order free |
| 7 | 0:21–0:26 | «SV 7» | VO | «SV 7» | Meat laid on clean bars with a sizzle; faces at the table out of focus; the review card with the name. | none | DRIVE 1gLEJU2bdzXWU-w2eHoxo9XD2jImMv_Zr [EDITOR PICKS: meat on clean bars with sizzle] | 101 close: "vad har du gjort med grillen?" | b-roll order free |
...
Whether the taste angle survives the move from user to giver — 088's mechanism with a daughter's voice.
