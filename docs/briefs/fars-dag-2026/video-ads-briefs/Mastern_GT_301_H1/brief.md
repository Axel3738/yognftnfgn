...
|---|---|---|
| 0–3 s · HOOK H1 | «SV H1» | «EN H1» — INTENT: He grills for twelve people every summer, then stands alone for twenty minutes. Object: the stacked plates / tongs on the tray after dinner. |
| 0–3 s · HOOK H2 | «SV H2» | «EN H2» — INTENT: The last thing he does every grill night is the one thing nobody thanks him for. Object: the wire brush on the side table under the lamp. |
| 0–3 s · HOOK H3 | «SV H3» | «EN H3» — INTENT: From the kitchen window she can see him; everyone else is inside. Object: the kitchen window with the grill glowing outside. |
| 3–9 s · PROBLEM | «SV 4» | «EN 4» — INTENT: He does everything right — good meat, the thermometer, resting — and then kneels twenty minutes with a wire brush that only reaches the top of the bars. The grease in the gaps stays. It was never him; it is the brush. |
| 9–14 s · THE GIFT | «SV 5» | «EN 5» — INTENT: This year she gives him the one thing he would never buy himself. The box opens: Mastern, two heads, gloves, the USB cable. |
| 14–22 s · FUNCTION | «SV 6» | «EN 6» — INTENT: One button. The head spins down into the gaps while the grate is still warm; a wet head, the steam does half the work; sixty seconds; two heads and nothing comes loose. |
| 22–27 s · OWNERSHIP | «SV 7» | «EN 7» — INTENT: Every weekend from now he sits down with us while the grate is still warm. Christer F. wrote: normally a job I put off for half an hour, now under a minute — quote it verbatim with the name. |
| 27–32 s · LOCK + CTA | «SV 8» | «EN 8» — INTENT: Price 999 kr, thirty days open purchase, lifetime warranty — if it breaks he gets a new one. The gift cannot go wrong. Then the giver's line from §6. |
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | 0:00–0:03 (H1) | «SV H1» | VO | «SV H1» | Macro of a stacked tray of empty plates and the grill tongs on the terrace table, terrace lamp on, dusk. **First frame:** the tray of plates, tongs on top. | cut-in | NEW FOOTAGE: the after-dinner tray on a terrace table in November light, filmed by Axel or UGC creator Beerhansson (folder 1ucL6wrOSre-h9m038xMZwjuWHLrYaeWN) | — | none |
| 2 | 0:00–0:03 (H2) | «SV H2» | VO | «SV H2» | Macro of a worn wire brush lying on the grill side table, terrace lamp, breath visible in the cold. **First frame:** the wire brush under the lamp. | zoom-in 1 s | DRIVE 1ZoRoDhf07RKXvKa-FMEx5zypdQwr3s90 [EDITOR PICKS: the worn wire brush on a table or grill edge, macro, no hands] | — | none |
| 3 | 0:00–0:03 (H3) | «SV H3» | VO | «SV H3» | Macro through a kitchen window: the grill lid open outside, a silhouette of his arm scrubbing, reflections of the indoor lamp on the glass. **First frame:** the window, the grill glow outside. | freeze 0.5 s then cut-in | NEW FOOTAGE: a kitchen window at dusk with the grill visible outside, filmed by Axel | — | none |
| 4 | 0:03–0:09 | «SV 4» | VO | «SV 4» | His hands scrubbing a grate with a wire brush, then macro into the gap between two bars: black crust untouched. | cut-in | DRIVE 1YY7Y_DuaPAszwF4jM70g0xue1N_hUsq6 [EDITOR PICKS: hands scrubbing with a wire brush + macro of black grease in a grate gap] | 110 B2 "flip the grate" beat | b-roll order free |
| 5 | 0:09–0:14 | «SV 5» | VO | «SV 5» | Hands open the Mastern box on the kitchen table: brush, second head, gloves, cable laid out one by one. | none | NEW FOOTAGE: unboxing on a kitchen table, filmed by Axel; the box exactly as shipped | — | none |
| 6 | 0:14–0:22 | «SV 6» | VO | «SV 6» | His hand presses the button; macro of the coarse head spinning in a gap, steam rising; black flakes lifting; cut to the polish head. | slow-mo 0.5× 2 s on the spinning head | DRIVE 1gLEJU2bdzXWU-w2eHoxo9XD2jImMv_Zr [EDITOR PICKS: coarse head spinning in a grate gap with steam, then the polish head] | — | b-roll order free |
| 7 | 0:22–0:27 | «SV 7» | VO | «SV 7» | He sits down at the terrace table, beer in hand, the grill behind him with the lid closed; the review as a caption card with the name. | none | DRIVE 1K2B_qE8jVlKng6k1Cpcw_GRsEOXD0aXZ [EDITOR PICKS: the griller sitting down at the table with a drink after cleaning] | 050 sitting-down beat | b-roll order free |
| 8 | 0:27–0:32 | «SV 8» | VO | «SV 8» | End card: Mastern on the grill edge, price, the two promises, button. | none | DRIVE 1K8LjlcndXuWdWI2ic7a0A4JDJqcnLaFe [EDITOR PICKS: the end card plate with Mastern on the grill edge] | — | none |
