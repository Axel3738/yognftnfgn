...
Samma filnamn som källan (enligt `naming-convention.md`), levererade i en mapp per
marknad så att original och översättning aldrig krockar:

```
out/no/MAGI_brush_pain_beforeafter_stains_v1.png   ← norska
out/fi/MAGI_brush_pain_beforeafter_stains_v1.png   ← finska
out/en/MAGI_brush_pain_beforeafter_stains_v1.png   ← engelska
```

Marknadskoder: `no`, `fi`, `en`.
