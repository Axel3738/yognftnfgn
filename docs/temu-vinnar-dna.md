...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Marin motorhölje 420D | ~104 900 (5 kampanjer) | ~523 | ~200 | 1,93 (huvud) | 1,63 | 299 | 116 | 2,6× | Motorhölje_PD_1_H3 (27 212 kr / 160 köp = 38 % / 44 % av huvudkampanjen, 73 % av nettovinsten) | klippt video: AI-b-roll + produktklipp + svensk VO + captions, ~30–40 s; rå kort leverantörsvideo (PD_EXTRA) bäst hold och 1 207 kr/1 000 men svalt i CBO | PD 59 % / SO 33 % / SP 8 % — alla tre block har lönsamma annonser |
| 2 | Fiskespöhållare (spöklämma) | 59 100 | 307 | 193 | 2,24 | 1,50 | 289 | 96 | 3,0× | Fiskespöhållare_PD_EXTRA ×3 ad-ID (23 029 kr / 128 köp = 39 % / 42 %, +18 848 kr) + PD_1_H1 (10 299 / 46) | **rå TikTok-ripp från leverantören** (vattenstämpel kvar, ingen caption, inget pris) — slog den klippta versionen på CTR, CPM och ROAS | PD 83 % / 80 %; CS 13 % / 18 % |
...
**1. Marin motorhölje 420D (299 kr).** Utombordaren sitter på akterspegeln vid bryggan hela säsongen → sol, salt och fågelspillning kritar en kåpa på en motor värd 20–100 tkr; presenningen flaxar och skaver → ett 420D-hölje med dragsko träs över på sekunder → kåpan behåller färg och andrahandsvärde. Annonsen: PD_1_H3, en klippt ~30–40 s video (AI-b-roll + produktklipp + svensk VO + captions), problem-konstaterande öppning, produkt i bild före sekund 4. CBO:n gav den 65 % dag ett; syskonen H1/H2 fick 28 respektive 48 kr och hooktestet lästes aldrig. "Allt dör vid skala utom PD_1_H3" (dna 08-09) ströks 08-19: när förlorarna pausades och budgeten halverades gick **alla** vinnare upp — taket var publiken (frekvens 3,21, marginell CPA 311 kr vid 4 000 kr/dag), inte creativen. Kontots högsta köp/klick (10,8 %) har `SO_4_H1`: "motorn kostade 80 000, höljet 299". Storlekstabell i bilden förstörde (`PD_6_1` −869 kr) — hk väljs på sidan, inte i flödet. **Bekant problem / bekant mekanism, avstånd 1 — obearbetat flöde.** Jula säljer ett kapell för 199 kr i 85 g/m²-polyester; vårt 420D är den synliga spec som motiverar 299. 0 svenska Meta-annonsörer. Systerprodukten Båtmotorskyddet (579 kr, heltäckande, launch 29 aug vid upptagningssäsongen) gör ROAS 3,50 första veckan — säsongsväxling och pris gav mer än fler hooks.

**2. Fiskespöhållare — i själva verket en spöklämma (289 kr, 4-pack).** Tvådelade spön glider isär, linan lindar sig runt guiderna, draget hakar i nästa spö; gummiband, tejp eller ingenting → en gångjärnsklämma med skum snäpps över topp och nederdel → spöt är ett stycke från garage till båt, kastklart på en sekund. Annonsen: **leverantörens råa TikTok-video** (PD_EXTRA, vattenstämpel "Lilybady" kvar, ingen caption, inget pris, visar aldrig trasslet — hooken är "efter"-läget), tre identiska ad-ID = 39 % / 42 %, +18 848 kr; den klippta versionen med AI-trassel (PD_1_H1) förlorade på CTR, CPM och ROAS. **Ekonomin sitter i flerköpet:** på styckpris är CPA 192,5 = BE-CPA 192,7 — noll marginal; AOV är 431 kr (1,49× priset) för att fri frakt kräver 300 kr och ett pack kostar 289. Hela vinstbidraget (+43 700 kr) bärs av andra packet. **Bekant problem / förbättrad mekanism, avstånd 2.** "Spöhållare" hos Biltema/Jula betyder relingsfäste eller väggställ (149–769 kr) — klämman finns inte i kedjorna; Ad Library: 0 konkurrenter. Butikssidan beskriver en vägghållare — spelade ingen roll, produkten säljs på video. Förlorarna i samma publik (magnetfiske 1,10, mini-spö 1,02, linupprullare 0,30) skapar en ny hobby, ersätter ett riktigt spö eller löser ett årligt problem som redan har en gratis lösning; klämman löser ett per-tur-problem på det han redan äger, med lägst kostnad i gruppen.
...
| **E. Ingen svensk kedja (Biltema/Jula/Clas/Rusta) säljer samma form och spec** | ½ (Jula 199 kr i 85 g/m²; vi 420D) | 1 (kedjornas "spöhållare" är en annan produkt) | 1 | 0 (EVA-clog 35 kr) | 0 (Jula 349, Clas 499) | 1 | 1 | 0 (Tapo 679) | 0 | 1 | 5½ | 10 % (18/20 jämförelsehandlade) | HÖGT PREDIKTIV — de fyra ½/0-vinnarna vann alla med en synlig spec- eller märkesskillnad |
| F. 0–1 svenska Meta-annonsörer i kategorin | 1 (13 träffar, alla våra) | 1 (0) | 1 | 1 | UNKNOWN | 1 | 1 | UNKNOWN | 0 (648) | 1 | 7 av 8 kända | okänt | HÖGT PREDIKTIV (mätt i 8) |
...
| O. Flerköp i praktiken (AOV/pris) | ½ (1,14) | **1 (1,49 — hela vinsten)** | ½ (1,08 på AOV 702) | ½ (1,2 par) | 0 | 0 | ½ (1,17) | 1 (1,70) | ½ (1,26) | 0 | 4½ | ej mätt | HÖGT PREDIKTIV för ekonomin — avgör om ROAS landar över BE i 2, 7, 8 |
...
| 3 | **(M ∨ O) ∧ N** — pris > 500 eller flerköp · uppslag ≥ 2,4× | 8 (alla tre), 2 (O bär allt), 3, 5, 6 (M), 7 (O) | 0/20 | Ger BE-CPA 350–525 kr (M) eller en order som är 1,2–1,7× styckpriset (O). Det är det enda som gör 0,6–1,3 % CVR (bandslip), 4 installationssteg (kamera) eller en CPA exakt på styckprisets break-even (spöhållaren) lönsamma. Kamerans 1,70 enheter/order är skillnaden mellan ROAS 2 och 3,4; spöhållarens 1,49 är skillnaden mellan 0 kr och +43 700 kr. | Hög för ekonomin | Hög (Meta + Shopify) |
...
| L. Storleksrisk | Motorhöljet (30 varianter, största vinnaren) | Varianter är ofarliga när ägaren **kan parametern utantill** (hk) och valet sker på sidan, inte i annonsen — storlekstabellen i bild (`PD_6_1`) gav −869 kr. Farliga när han måste mäta eller gissa (skostorlek 36–47, "passar de flesta"). Rätt variabel: *ägarkunskap om parametern*, inte antal varianter. | NEGATIV-svag → omdefinierad |
| Spöhållaren: CPA = BE-CPA | På styckpris tjänar kampanjen noll | Vinsten är flerköpet (AOV 1,49× pris) som fri-fraktgränsen 300 kr framkallar vid pris 289. En konstruerbar hävstång: pris strax under gränsen + multipack som är meningsfullt ×2. | Ny variabel (avsnitt 9) |
| "Allt dör vid skala" (motorhöljet) | Ströks 08-19 | Det var publiktak (frekvens 3,2) och CBO-svält, inte creativen. Skalningsproblemet är en kampanjstruktur- och publikfråga; produkten var robust (8 av 17 dömbara annonser lönsamma, alla tre vinklar). | Omtolkad |
...
7. **Flerköpsskäl (0/1) + fri-frakt-hävstången.** Finns ett fysiskt skäl att äga 2–3 (flera ställen, flera personer, flera spön)? Kamera 1,70 enheter/order avgjorde ROAS; spöhållaren 1,49 var hela vinsten. Hävstången är konstruerbar: pris strax under fri-fraktgränsen (289 mot 300) + ett multipack som är meningsfullt ×2. Mät: antal ägda enheter kunden har ÷ antal i packet, och prisets läge mot fraktgränsen.
...
**Överviktade:**
- 4-vinkelsstrukturen (CS/G/PD/SP × 3 videor). G: 0 köp i tre kampanjer. SP-kort: 0 bedömbara i sex kampanjer. CS: lönsam i 2, 6 och 8 — men i alla tre på en rabatt- eller knapphetsclaim som butikssidan inte täcker ("40 % rabatt" utan jämförpris, "slut inom kort"). CS är en regelrisk, inte en strategi. Sex av tolv launchvideor per produkt går till vinklar som aldrig vunnit rent.
...
- Flerköp: bundle-planer är BLOCKER i tre backlogs (4, 5, 9) medan kameran (1,70) och spöhållaren (1,49 — hela vinsten) bevisar effekten. Fri-fraktgränsen 300 kr är i dag en oavsiktlig hävstång (spöhållaren 289) och en irritation (motorhöljets 3★-recension: "kan köpa ett för 351 kr så slipper vi frakten").
- Publiktak: motorhöljet mättades vid ~2 000 kr/dag (frekvens 3,2); den säsongsväxlade systerprodukten (Båtmotorskyddet, 579 kr) gav ROAS 3,50 första veckan. Skalning av en vinnare = ny produkt till samma ägare i nästa säsongsfas, inte fler hooks.
...
**B. TOPPVARIABLER, rankade.** (1) Ägarpresens — problemet finns nu, hos någon som äger objektet, och objektet står ute eller används kroppsligt. (2) Hyllfrånvaro + 0–1 annonsörer, eller en synlig spec-/märkesskillnad (420D mot 85 g/m², två linser, Crocs, Husqvarna). (3) Materialöverförbarhet — leverantörens video/foto duger som annons, med captions eller rakt av. (4) Prisutrymme: ≥ 2,4× kostnad och ≥ 300 kr; > 500 kr har aldrig förlorat. (5) Flerköp — AOV över styckpris i 5 av 9, hela vinsten i spöhållaren, ROAS 3,4 i kameran. (6) Ägarfråge-hook på ≤ 7 ord. (7) Man 45–70, småhus/fritidshus. (8) Launch inom säsong (förutsättning för 1). (9) Ägarkänd variantparameter. (10) Old way = improvisation.
...
**E. TEMU-SIGNALER.** Alla numeriska signaler UNKNOWN (blockerat) — och sannolikt svaga diskriminatorer eftersom förlorarna valdes med samma signaler. Det som bär är leverantörens **video** (produkt i bruk ≤ 3 s, samma produkt, ingen inbränd text) och en textfri hero i kontext — och videon behöver inte ligga på Temu-sidan: spöhållarens vinnare var leverantörens TikTok-klipp (snaptik-nedladdning med vattenstämpel). Titel, kategori, galleriantal och material är brus.
