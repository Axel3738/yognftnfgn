...
s("C (strukturellt: marketplace-golv)", "V2.2 fas 1 (v22/fas1/lockskydd-spabad.md): Fyndiq säljer identisk oxford cover cap 218×218×30 cm för 343–389 kr, Hemson 499, Amazon.se 634 — identiskt billigt alternativ under vårt pris; ankaret 1 290–1 495 räddar inte det. Ekonomin var grön (19,39 USD → 2,5–3,0×) och alternativ listning 601099816288753 hade en användbar hero — men hyllan (marketplace-golvet) fäller konceptet, inte listningen. Lärdom: h4.json noterade 499–785 på PriceRunner i fritext efter ordet 'dock' — ett tal som fäller får aldrig stå i en kommentar.", 601099619866532)
...
s("B (närmast A — TEST IF VERIFIED, V2.2)", "V2.2: pris 599 (inte 499), landad 170–199 → 3,0–3,5×; köp 3–5 kg-versionen; setrimmer.se säljer samma form 288/365 kr i lager — spela mot ankaret Kindling Cracker 1 249, aldrig mot 288. Material BLOCKED_SOURCE på alla 25 listningar utom packshoten; prioritera 601099702553211 (handskar → hand i bild), 601099595396016 (GoPlus) och 601099561039096 (9 lbs halv-ring). Blir A när en video visar slaget och stickan inom 3 s.", 601099583674464)
s("C (strukturellt: marketplace-golv)", "V2.2 fas 1 (v22/fas1/vedstallsoverdrag.md): fyra prisobservationer 24,22 / 29,71 / 29,99 / 34,47 USD — billigaste ger landad 253–296 → 2,4× kräver 607–711 kr; vidaXL.se säljer exakt samma form för 293 kr i lager, under DNA:ns 300-kronorsgolv. Inget svenskt pris klarar 2,4×, 300 kr och hyllan samtidigt. Materialet (hero på fullt vedställ) var aldrig problemet.", 601099615828436)
