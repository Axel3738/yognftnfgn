...
5. Ägarbyte: klart enligt VA:n 2026-09-08 → **axelodhner.business@gmail.com** (API:t kan inte läsa ägarens mejl — `staffMembers` nekas för appen; `shopOwnerName` = Axel Odhner före och efter). Checklistan hade fel adress — rättad i `checklista.mjs` (inkorg ≠ ägare). Kvar: Axel väljer plan innan trialen går ut om 2 dagar.
