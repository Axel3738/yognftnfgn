...
// kalenderlucka, koja = utekattkoja på ben, ingen = bara ordmärket. Väljs med
...
async function huvud() {
  ...
  if (!butiksfil) {
    console.error('Användning: node factory/logga-generera.mjs factory/butiker/<butik>.yaml [--ut <mapp>] [--variant a|b|c] [--tagline "…"] [--motiv droppe|lucka|koja|ingen]');
    process.exit(1);
  }
