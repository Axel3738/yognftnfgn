...
|---|---|---|
| **4446** — inquiry, credit not processed, **1262.20 SEK**, needs response, **evidence due 2026-09-23**, no refund ever issued | No contact found in the inbox | **FIGHT.** The claim is factually wrong: no refund was ever requested or issued. Delivery scan + policy page + the no-contact sentence + the email we sent. Biggest amount open — do it first |
