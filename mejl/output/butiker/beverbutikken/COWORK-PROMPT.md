# Cowork-prompt: fraktmejlen + menylänken i Beverbutikken (beverbutikken.no)

Byggd av `node mejl/bygg-butik.mjs beverbutikken`. Hela mallen byts — inte enskilda
...
Du jobbar i Chrome i mitt inloggade Shopify-konto för butiken **Beverbutikken**
(beverbutikken.no, 1acuam-s5.myshopify.com). Uppgifter: **A.** byta ut koden i
...
Kontrollera först att https://beverbutikken.no/pages/spor svarar och visar rubriken "Spor pakken din".
...
|---|---|---|---|---|---|
| 1 | **Leveransbekräftelse / Shipping confirmation** | `Pakken din er på vei` | `BB-` och `sha256` | **10 436** | https://raw.githubusercontent.com/Axel3738/yognftnfgn/main/mejl/output/butiker/beverbutikken/fraktbekraftelse.liquid |
| 2 | **Leveransuppdatering / Shipping update** | `Ny info om pakken din` | `BB-` och `sha256` | **6 240** | https://raw.githubusercontent.com/Axel3738/yognftnfgn/main/mejl/output/butiker/beverbutikken/fraktuppdatering.liquid |
| 3 | **Ute för leverans / Out for delivery** | `Pakken kommer i dag` | `BB-` och `sha256` | **6 243** | https://raw.githubusercontent.com/Axel3738/yognftnfgn/main/mejl/output/butiker/beverbutikken/ute_for_leverans.liquid |
...
3. Samma i **Sidfotsmeny** (Footer menu) — heter den något annat, ta den meny sidfoten på beverbutikken.no faktiskt visar.
4. Kontrollera i kundens vy: öppna https://beverbutikken.no i en ny flik, ladda om, se att **Spor pakken** syns i huvudmenyn och sidfoten och landar på "Spor pakken din".
...
`https://beverbutikken.no/pages/spor?nummer=BB-`. (Sidan säger att den inte hittar numret för
