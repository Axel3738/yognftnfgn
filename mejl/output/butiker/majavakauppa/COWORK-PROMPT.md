...
går ett mejl till **asiakaspalvelu@majavakauppa.fi** med en länk som Axel klickar — stanna
...
|---|---|---|---|---|---|
| 1 | **Leveransbekräftelse / Shipping confirmation** | `Pakettisi on matkalla` | `BB-` och `sha256` | **10 607** | https://raw.githubusercontent.com/Axel3738/yognftnfgn/main/mejl/output/butiker/majavakauppa/fraktbekraftelse.liquid |
| 2 | **Leveransuppdatering / Shipping update** | `Uutta tietoa paketistasi` | `BB-` och `sha256` | **6 241** | https://raw.githubusercontent.com/Axel3738/yognftnfgn/main/mejl/output/butiker/majavakauppa/fraktuppdatering.liquid |
