...
|---|---|---|---|---|---|
| 1 | **Leveransbekräftelse / Shipping confirmation** | `Pakettisi on matkalla` | `BB-` och `sha256` | **10 601** | https://raw.githubusercontent.com/Axel3738/yognftnfgn/main/mejl/output/butiker/majavakauppa/fraktbekraftelse.liquid |
| 2 | **Leveransuppdatering / Shipping update** | `Uutta tietoa paketistasi` | `BB-` och `sha256` | **6 235** | https://raw.githubusercontent.com/Axel3738/yognftnfgn/main/mejl/output/butiker/majavakauppa/fraktuppdatering.liquid |
| 3 | **Ute för leverans / Out for delivery** | `Paketti saapuu tänään` | `BB-` och `sha256` | **6 243** | https://raw.githubusercontent.com/Axel3738/yognftnfgn/main/mejl/output/butiker/majavakauppa/ute_for_leverans.liquid |
...
enda knapp **Seuraa pakettia**, länken börjar med
`https://majavakauppa.fi/pages/seuranta?nummer=BB-`. (Sidan säger att den inte hittar numret för
