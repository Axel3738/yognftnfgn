...
- ⛔ **13 FLÖDEN LIVE sedan 2026-09-25 ~10:40 CEST** (Axels ord: "Nu sätter vi igång alla fucking flows"), påslagna med `klaviyo/sla-pa.mjs --ja`. Kampanjerna K01–K14 är fortfarande utkast. Id:n i `klaviyo/README.md`. Leveranstiden står aldrig i ett mejl (Axel igen samma dag).
