...
- ✅ **Spoks byggt 2026-09-26 (Axels order "bygg i spoks")**: 13 flöden + F14 och 22 kampanjutkast i Spoks workspace Bäverbutiken `f716ae36-…`. ⛔ **ALLA FLÖDEN LIVE sedan 2026-09-26 09:02–09:05 CEST** (Axels klick i appen; mätt med `get_flows`). F04 ersatt 10:16 av **F04 v2 (kredit)** `bfc5beee-…` med butikskrediten KREDIT100; gamla F04 `786d2580-…` har båda sändstegen av (dess E1 bar lyckohjulet och raden "ADD COUPON HERE: TACKIGEN", hann aldrig gå ut). F11 väntar 21 dagar (Axels ändring). K01 schemalagd tis 29/9 18:00, K02–K22 utkast. Flöden, mejlsteg och utskick slås på bara i Spoks-appen; MCP:n ändrar bara inaktiva flöden. Läget: `klaviyo/spoks/README.md`. Id:n, triggers och skillnaderna mot Klaviyo (inget ordernummer, ingen Fulfilled Order-trigger, ingen sunset) i `klaviyo/spoks/README.md`. ⛔ **Klaviyo AVSTÄNGT 2026-09-26** (Axels order: "jag vill inte ha Klaviyo, jag vill bara köra Spoks"): alla 13 flöden i `QZ4jLG` satta till draft och K01 återkallad till utkast med `node klaviyo/stang-av.mjs --ja` (logg `klaviyo/konto/baverbutiken/avstangt.jsonl`, tillbakaläst: 0 igång). Slå aldrig på något i Klaviyo igen utan Axels ord. Spoks-planen är Paid (obegränsat, mätt med whoami); avsändaradressen saknades (senderEmail null).
