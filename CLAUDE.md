...
creative strategy och Evolve-metoden. Kontot är `TMFt7M` (syns i sajtens HTML). Börja i
...
| `/klaviyo <kolla\|bygg\|ladda-upp\|rapport\|cs>` | **E-postmarknadsföringen i Klaviyo** (Bäverbutiken, konto `TMFt7M`, byggd 2026-09-24): innehåll → byggda mejl med live-priser → segment, mallar, kampanjer och flöden i Klaviyo, ALLTID som utkast. `cs` = veckoloopen (rapport → lärdom → nya koncept). `klaviyo/README.md` |
