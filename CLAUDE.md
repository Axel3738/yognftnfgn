...
| `/ugc-va <find\|reply\|deal\|sent\|delivered\|status> …` | **UGC-outreach som VA:n kör själv** (Axels beslut 2026-09-24: "bara VA:n", eget Claude-konto, samma repo — ingen betald plattform, inga automatiska DM:s). Engelska till VA:n, svenska till kreatörerna med engelsk betydelse under. Hittar kreatörer, skriver första meddelandet, översätter svar och föreslår nästa steg på förhandlingsstegen, skriver avtal + brief, spårar leverans, skriver betalningsbegäran till Axel. **VA:n skickar själv inom `factory/ugc/villkor.md`** (1 500 kr/video, max 3 000 kr för 14–16 poäng); allt utanför ⇒ Axel. Axel betalar alltid. Bara produkter i villkor.md → "Produkter som får UGC just nu". Regelbok `factory/ugc/VA-SOP.md`, minnet `factory/ugc/pipeline.md` (pushas till `main` varje körning, inga adresser) |
