...
tillbaka och rätt (språk, signatur, order ur Shopify, spårningslänk med
bävernummer, kundens mejl citerat under). Det som brast första gången var
webbmejlens skrivväg (302 i steg 7, `INBOX.`-prefixet i steg 11) och Discords
2000-teckenstak — alla tre rättade samma kväll, den falska servern i testerna
härmar nu det riktiga svaret. En rad med `atgard: 'fel'` i loggen räknas inte
