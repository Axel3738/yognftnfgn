# Taköverdraget — finska kampanjen, körlogg (2026-09-18)

Spec: `FI-KAMPANJ.md`. Byggd av `fi-kampanj/` (skripten där, alla texter i `copy/`, `vo/`, `bilder/`).

**Konto:** Magiborsten FI `act_1619718346388201` (valuta SEK — inte EUR som specen antog; budgetar anges i öre). **Sida:** Majavakauppa `1317870104733246`. **Pixel:** `1554276343018184` (Bäverbutiken.se — kontots enda köp-pixel, samma som Axels 19 befintliga FI-adsets; majavakauppa.fi skickar i dag ingen Meta-pixel alls — se frågan till Axel i leveransen). **Kampanj:** `Kattopeite Asuntovaunu | FI | Launch 2026-09-18` → `120251780248980199`, CBO 1100 kr/dag (≈ 100 €) som platshållare, PAUSED.

Verifiering 2026-09-18 (`effective_status`): kampanj `PAUSED`, 10 adsets (alla PAUSED), 34 annonser: 21 PAUSED + 13 PENDING_REVIEW (alla skapade med `status: PAUSED`; PENDING_REVIEW är Metas granskning av nya annonser och levererar inte medan kampanj och adset är pausade).

## Adsets

| SE | FI | ID |
|---|---|---|
| CO | Notionrunda 2026-09-15 | FI | CO | Notionrunda 2026-09-15 | `120251780255390199` |
| RI | Notionrunda 2026-09-16 | FI | RI | Notionrunda 2026-09-16 | `120251780255820199` |
| Taköverdrag Husvagn 6,5 × 3 m | SP | 2026-09-09 | FI | Taköverdrag Husvagn 6,5 × 3 m | SP | 2026-09-09 | `120251780256180199` |
| UG | Notionrunda 2026-09-16 | FI | UG | Notionrunda 2026-09-16 | `120251780256790199` |
| Taköverdrag Husvagn 6,5 × 3 m | GT | 2026-09-09 | FI | Taköverdrag Husvagn 6,5 × 3 m | GT | 2026-09-09 | `120251780257160199` |
| Taköverdrag Husvagn 6,5 × 3 m | PD | 2026-09-09 | FI | Taköverdrag Husvagn 6,5 × 3 m | PD | 2026-09-09 | `120251780257560199` |
| BOF | Notionrunda 2026-09-15 | FI | BOF | Notionrunda 2026-09-15 | `120251780258070199` |
| Taköverdrag Husvagn 6,5 × 3 m | CS | 2026-09-09 | FI | Taköverdrag Husvagn 6,5 × 3 m | CS | 2026-09-09 | `120251780258570199` |
| LI | Notionrunda 2026-09-15 | FI | LI | Notionrunda 2026-09-15 | `120251780259140199` |
| TR | Notionrunda 2026-09-15 | FI | TR | Notionrunda 2026-09-15 | `120251780259610199` |

## Annonser

| SE-namn | FI-namn | FI-ad-ID | Status |
|---|---|---|---|
| Takoverdrag_CO_1_H1 | FI_Takoverdrag_CO_1_H1 | `120251780304170199` | uppladdad, PAUSED |
| Takoverdrag_RI_1_H1 | FI_Takoverdrag_RI_1_H1 | `120251780304370199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_SP_4_H1 | FI_Takoverdrag_SP_4_H1 | `120251780305300199` | uppladdad, PAUSED |
| Takoverdrag_UG_1_H1 | FI_Takoverdrag_UG_1_H1 | `120251780305390199` | uppladdad, PAUSED |
| Takoverdrag_GT_4_H1 | FI_Takoverdrag_GT_4_H1 | `120251780305520199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_PD_4_H1 | FI_Takoverdrag_PD_4_H1 | `120251780305880199` | uppladdad, PAUSED |
| Takoverdrag_GT_5_H1 | FI_Takoverdrag_GT_5_H1 | `120251780306020199` | uppladdad, PAUSED |
| Takoverdrag_BOF_2_1 | FI_Takoverdrag_BOF_2_1 | `120251780307410199` | uppladdad, PAUSED |
| Takoverdrag_BOF_1_1 | FI_Takoverdrag_BOF_1_1 | `120251780307920199` | uppladdad, PAUSED |
| Takoverdrag_CO_2_1 | FI_Takoverdrag_CO_2_1 | `120251780308140199` | uppladdad, PAUSED |
| Takoverdrag_BOF_3_1 | FI_Takoverdrag_BOF_3_1 | `120251780308210199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_CS_4_1 | FI_Takoverdrag_CS_4_1 | `120251780308350199` | uppladdad, PAUSED |
| Takoverdrag_GT_6_1 | FI_Takoverdrag_GT_6_1 | `120251780310870199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_CS_6_1 | FI_Takoverdrag_CS_6_1 | `120251780312180199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_PD_5_1 | FI_Takoverdrag_PD_5_1 | `120251780312830199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_LI_1_1 | FI_Takoverdrag_LI_1_1 | `120251780313260199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_SP_5_1 | FI_Takoverdrag_SP_5_1 | `120251780313620199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_TR_1_1 | FI_Takoverdrag_TR_1_1 | `120251780313860199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_SP_2_1 | FI_Takoverdrag_SP_2_1 | `120251780314260199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_SP_3_H1 | FI_Takoverdrag_SP_3_H1 | `120251780315160199` | uppladdad, PAUSED |
| Takoverdrag_SP_2_H1 | FI_Takoverdrag_SP_2_H1 | `120251780315800199` | uppladdad, PAUSED |
| Takoverdrag_SP_1_H1 | FI_Takoverdrag_SP_1_H1 | `120251780316510199` | uppladdad, PAUSED |
| Takoverdrag_PD_2_1 | FI_Takoverdrag_PD_2_1 | `120251780316990199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_PD_3_H1 | FI_Takoverdrag_PD_3_H1 | `120251780317560199` | uppladdad, PAUSED |
| Takoverdrag_PD_2_H1 | FI_Takoverdrag_PD_2_H1 | `120251780318190199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_PD_1_H1 | FI_Takoverdrag_PD_1_H1 | `120251780318680199` | uppladdad, PAUSED |
| Takoverdrag_GT_2_1 | FI_Takoverdrag_GT_2_1 | `120251780319420199` | uppladdad, PAUSED |
| Takoverdrag_GT_3_H1 | FI_Takoverdrag_GT_3_H1 | `120251780319990199` | uppladdad, PAUSED |
| Takoverdrag_GT_2_H1 | FI_Takoverdrag_GT_2_H1 | `120251780321250199` | uppladdad, PENDING_REVIEW |
| Takoverdrag_GT_1_H1 | FI_Takoverdrag_GT_1_H1 | `120251780321640199` | uppladdad, PAUSED |
| Takoverdrag_CS_2_1 | FI_Takoverdrag_CS_2_1 | `120251780322820199` | uppladdad, PAUSED |
| Takoverdrag_CS_3_H1 | FI_Takoverdrag_CS_3_H1 | `120251780323530199` | uppladdad, PAUSED |
| Takoverdrag_CS_2_H1 | FI_Takoverdrag_CS_2_H1 | `120251780324380199` | uppladdad, PAUSED |
| Takoverdrag_CS_1_H1 | FI_Takoverdrag_CS_1_H1 | `120251780325710199` | uppladdad, PAUSED |
