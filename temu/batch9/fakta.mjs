...
export const FAKTA = {
  ...
  snoflingor: { batch: 10, sku: 'TEMU-B10-SNOFLINGOR', kategori: 'gid://shopify/TaxonomyCategory/hg-3-58',
    kalla: `${B}/image20.png (597 px: 6×4-rutnät med 24 flingor + garageport med flingorna) · ${B}/image27.jpg (mått 4,1 × 5,0 cm) · ${B}/image15.jpg (collage, INTE förpackningen)`,
    latt: { antal: 24, storlekCm: [4.1, 5.0], motiv: 'snöflingor i vitt, blått och silver', anvandning: 'garageport, fönster, dörr' },
    obs: '⚠️ Axels radnamn säger 25-pack, leverantörens rutnät visar 24. Räknebart vinner: 24. Antalet ska synas i titel, som badge på huvudbilden och som första bullet. Inget om häftmassa/magnet/vad de fäster med.', varning: null },
