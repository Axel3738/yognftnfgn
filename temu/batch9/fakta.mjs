...
export const FAKTA = {
  ...
  kajakhallare: { batch: 10, sku: 'TEMU-B10-KAJAKHALLARE', kategori: 'gid://shopify/TaxonomyCategory/hg-10-16-9',
    kalla: `${B}/image26.png (1500 px: två krokar, 4 skruvar, 4 pluggar (räknade 2026-09-12 — en tidigare läsning sa 8), "15.1 inch", "100 Lbs", kinesisk vattenstämpel — beskärs/undviks) · ${B}/image5.png (576 px, krokarna med kajaker)`,
    latt: { antal: 2, armLangdCm: 38, lastKg: 45, ingar: '2 krokar, 4 skruvar, 4 pluggar', farg: 'svart med gula ändskydd' },
