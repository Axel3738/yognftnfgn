...
export const AI = {
  ...
  bordsfotboll: {
    ...
    bilder: [
      { namn: 'ai-spel', ref: 'Bordsfotbollsplanen med sarg, målbur', alt: 'Två barn spelar bordsfotboll vid köksbordet, bara händerna syns (AI-illustration)', prompt: 'The same tabletop football game on a kitchen table, two children\'s hands on the sliders mid-game, warm evening light, no faces.' },
      { namn: 'ai-mal', ref: 'Bordsfotbollsplanen med sarg, målbur', alt: 'Bollen på väg in i målet, en hand på skjuthandtaget (AI-illustration)', prompt: 'Close-up of the same tabletop football game: the small ball rolling into the goal, one child\'s hand on the slider handle, shallow depth of field, no faces.' },   // Axel 2026-09-24: "inga nice produktbilder när folk spelar"
    ] },
  ...
  magnetblock: {
    ...
    bilder: [
      { namn: 'ai-hero', plats: 'hero', ref: '200 magnetiska kuber med block- och gräsmotiv', alt: 'Magnetblocken på ett ljust barnrumsgolv (AI-illustration)', prompt: 'The same pile of printed magnetic cubes placed on a light wooden floor in a bright child\'s room, a few of the same cubes stacked into a small tower beside the pile, soft daylight from a window. No box, no packaging, no text anywhere.' },   // Axel 2026-09-24: QC-högen "ser ut som tagen på ett lager". Första försöket hittade på en låda med "Ages 3+" — därför utan låda.
      { namn: 'ai-lek', ref: 'Bygge med magnetiska byggblock', alt: 'Barnhänder bygger med magnetblocken på golvet (AI-illustration)', prompt: 'Two children\'s hands building with the same magnetic cubes on a living-room rug, the finished build from the reference in front of them, no faces.' } ] },
  ...
  rullknivslip: {   // video struken 2026-09-24: GIF:en visade inte användningen (Axel) — sidan får bild i stället (galleri.mjs gif: false)
    bilder: [
  ...
  vedklyvshuv: { video: { ref: 'Huven över vedklyven i ett förråd', typ: 'FIRST_AND_LAST_FRAMES_2_VIDEO', start: 1.5, prompt: 'A hand reaches in and pulls the drawstring tight at the lower corner of the matte black cover; the cover stays solid opaque black and fitted over the log splitter; nothing else moves.' } },   // omgjord 2026-09-24: referens 09 såg genomskinlig ut → GIF:en blev "en presenning" (Axel)
  adelstenskalender: {
    video: { ref: 'Ädelstenskalendern öppen: 24 luckor, grävblocken', typ: 'FIRST_AND_LAST_FRAMES_2_VIDEO', prompt: 'A child\'s hand picks up the small black hammer and taps the pastel dig block in front; the block cracks open and a shiny gemstone appears inside it; the red box behind stays exactly as it is.' },   // omgjord 2026-09-24: första GIF:en var stillbild med en hand (Axel: "riktigt dålig")
    bilder: [ { namn: 'ai-hero', ref: 'Den röda asken öppen med grävblocken o', alt: 'Ädelstenskalendern öppen på bordet med grävblocken och verktygen, barnhänder gräver (AI-illustration)', prompt: 'The same red advent calendar box, open, on a wooden table in warm Christmas light, the pastel dig blocks and small tools laid out in front, a child\'s hands brushing one block, no faces. The printed lid must stay exactly as in the reference: the gold "Merry Christmas" lettering and the Santa illustration, nothing else written on the box.' } ] },
  husbilskalender: {
  ...
  tradansikte: { video: { ref: 'Mossigt leende med två ekorrar', prompt: 'Wide shot with the whole tree face fully in frame – eyes, nose and mouth on the trunk with space above the eyes; two squirrels climb a little on the bark while leaves move in a light breeze; the face stays exactly as in the reference.' } },   // bildstart (1:1) beskars till 16:9 av Veo → ögonen hamnade utanför GIF:en; referensläge i stället
