// Slår ihop copy-1..3.json → copy.json och granskar varje rad mot reglerna.
...
const copy = {};
for (const n of [1, 2, 3]) { const f = path.join(HÄR, `copy-${n}.json`); if (existsSync(f)) Object.assign(copy, JSON.parse(readFileSync(f, 'utf8'))); }
