// Slår ihop copy-1..4.json → copy.json och granskar varje rad mot reglerna.
...
const copy = {};
for (const n of [1, 2, 3, 4]) { const f = path.join(HÄR, `copy-${n}.json`); if (existsSync(f)) Object.assign(copy, JSON.parse(readFileSync(f, 'utf8'))); }
