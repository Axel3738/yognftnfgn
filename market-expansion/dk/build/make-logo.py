#!/usr/bin/env python3
"""Genererar Bæverbutikken-wordmark (PNG, transparent) i temats designspråk:
kraftig versal text + röd accent (.DK), i stil med Anton-typsnittet.
...
render("BÆVERBUTIKKEN", ".DK", "baeverbutikken-logo.png", SVART)
render("BÆVERBUTIKKEN", ".DK", "baeverbutikken-logo-white.png", VIT)
render("BÆVERBUTIKKEN", "", "baeverbutikken-logo-plain.png", SVART)
...
d.text(((size - (b[2] - b[0])) / 2 - b[0], (size - (b[3] - b[1])) / 2 - b[1]), "B",
       font=f, fill=VIT)
img.save(OUT / "baeverbutikken-favicon.png")
print("baeverbutikken-favicon.png", img.size)
