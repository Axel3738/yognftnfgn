#!/usr/bin/env node
// Genererar JSONL med productSet-inputs för bæverbutiken.dk.
// Förbättring mot Norge-körningen: inventoryPolicy CONTINUE + templateSuffix sätts INLINE.
import { readFileSync, writeFileSync } from 'node:fs';

const LOCATION = 'gid://shopify/Location/111991947609';
const COLL = {
  'tradgard-utomhus': 'gid://shopify/Collection/710087803225',   // Garden & Outdoors
  'bil-verktyg-garage': 'gid://shopify/Collection/710087835993', // Car, Tools & Garage
  'camping-friluft': 'gid://shopify/Collection/710087868761',    // Camping & Outdoor Life
  'lantbruk-djur': 'gid://shopify/Collection/710087901529',      // Farming & Animals
  'bat-marin': 'gid://shopify/Collection/710087934297',          // Boat & Marine
  'tillbehor-ovrigt': 'gid://shopify/Collection/710087967065',   // Accessories & More
  'fordon-belysning': 'gid://shopify/Collection/710087999833',   // Vehicles & Lighting
};
const FRONTPAGE = 'gid://shopify/Collection/683019764057';

const cat = JSON.parse(readFileSync(new URL('../output/catalog.dk.json', import.meta.url)));
const lines = [];
