#!/usr/bin/env node
// Batchdrivare för US-annonserna, CaraShell takskyddet 2026-09-23 (13 videor).
// Kör tools/ops-till-meta.mjs en rad i taget mot den kampanj kön dömde (--kampanj ur
// jobb.json). Utan --skarpt bara torrkörning.
//   node market-expansion/ops/carashell/2026-09-23-us/ladda-upp.mjs [--bara <mal_namn>] [--skarpt]
