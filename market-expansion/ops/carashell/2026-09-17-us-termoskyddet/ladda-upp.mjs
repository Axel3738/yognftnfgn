#!/usr/bin/env node
// Batchdrivare för US-bildannonserna, CaraShell termoskyddet batch #2, 2026-09-17.
// Kör tools/ops-till-meta.mjs en bild i taget mot US-kampanjen kön dömde
// (--kampanj ur jobb.json). Utan --skarpt bara torrkörning.
//   node market-expansion/ops/carashell/2026-09-17-us-termoskyddet/ladda-upp.mjs [--bara <mal_namn>] [--skarpt]
