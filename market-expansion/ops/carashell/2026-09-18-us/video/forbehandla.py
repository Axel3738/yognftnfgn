...
Läser video/render/carashell_<n>.mp4 → video/forbehandlad/carashell_<n>.mp4 (kopieras rakt
av när videon saknar röda texter).
"""
...
for n, rutor in F.items():
    ...
    if not rutor:
        shutil.copyfile(inn, ut); print(n, "kopierad (inga röda texter)"); continue
