...
// punkter. Hela historiken finns kvar bakom "Visa fullständig
// transporthistorik"; det här är bara en gruppering av skanningar som redan
// finns, aldrig ett nytt datum och aldrig en ny status.
//
