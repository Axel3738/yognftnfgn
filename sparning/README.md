...
| CaraShell | ✅ (fabrikens app "Factory", 154 scopes) | ✅ | **live 2026-09-20: https://carashell.se/pages/spara** — 141 registrerade, 138 event, 140 paket på sidan, CS-nummer. **Mejl + meny klara samma kväll** (Cowork: tre mallar, Main + Footer menu, testmejl — `cowork/carashell.md` → Utfall) |
