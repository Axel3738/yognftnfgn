  ...
  campaigns: [
    {
      ...
      adsets: [
        ...
        {
          // spegel av broad_advplus_purchase_nya16 — EN_s008h1 saknas i biblioteket
          name: 'us_broad_advplus_purchase_ugc_1',
          copy: COPY_UGC, link: LP,
          motifs: [
            { name: 'MATSTRUMP_US_sushi_fomo_ugc_november_v1',  media: 'EN_november' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_somneth1_v1',  media: 'EN_somneth1' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_somneth2_v1',  media: 'EN_somneth2' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_somneth3_v1',  media: 'EN_somneth3' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_haikuh1_v1',   media: 'EN_haikuh1' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_haikuh2_v1',   media: 'EN_haikuh2' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_haikuh3_v1',   media: 'EN_haikuh3' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s009h1_v1',    media: 'EN_s009h1' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s009h2_v1',    media: 'EN_s009h2' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s009h3_v1',    media: 'EN_s009h3' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_trodde_v1',    media: 'EN_trodde' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s008h2_v1',    media: 'EN_s008h2' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s008h3_v1',    media: 'EN_s008h3' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_julstrumpa_v1', media: 'EN_julstrumpa' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_opush1_v1',    media: 'EN_opush1' },
          ],
        },
        {
          // spegel av broad_advplus_purchase_alla17
          name: 'us_broad_advplus_purchase_ugc_2',
          copy: COPY_UGC, link: LP,
          motifs: [
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s001h1_v1', media: 'EN_s001h1' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s002h1_v1', media: 'EN_s002h1' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s002h2_v1', media: 'EN_s002h2' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s002h3_v1', media: 'EN_s002h3' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s003h1_v1', media: 'EN_s003h1' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s003h2_v1', media: 'EN_s003h2' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s003h3_v1', media: 'EN_s003h3' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s004h1_v1', media: 'EN_s004h1' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s004h2_v1', media: 'EN_s004h2' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s004h3_v1', media: 'EN_s004h3' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s004h4_v1', media: 'EN_s004h4' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s006h1_v1', media: 'EN_s006h1' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s006h2_v1', media: 'EN_s006h2' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s006h3_v1', media: 'EN_s006h3' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s007h1_v1', media: 'EN_s007h1' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s007h2_v1', media: 'EN_s007h2' },
            { name: 'MATSTRUMP_US_sushi_gift_ugc_s007h3_v1', media: 'EN_s007h3' },
          ],
        },
      ],
    },
