// se-adventlaneracing-image.config.mjs — AdventLaneRacing SE, skriven av factory/vagkonfig.mjs 2026-09-10.
  ...
  adsets: [
    {
      ...
      ads: [
        {
          "adName": "AdventLaneRacing_PD_2_1",
          "img": "AdventLaneRacing_PD_2_1.jpg",
          "copy": {
    ...
    },
    {
      ...
      ads: [
        {
          "adName": "AdventLaneRacing_GT_2_1",
          "img": "AdventLaneRacing_GT_2_1.jpg",
          "copy": {
    ...
    },
    {
      ...
      ads: [
        {
          "adName": "AdventLaneRacing_CS_2_1",
          "img": "AdventLaneRacing_CS_2_1.jpg",
          "copy": {
    ...
    },
    {
      ...
      ads: [
        {
          "adName": "AdventLaneRacing_SP_2_1",
          "img": "AdventLaneRacing_SP_2_1.jpg",
          "copy": {
