// no-adventlaneracing-image.config.mjs — AdventLaneRacing NO, skriven av factory/vagkonfig.mjs 2026-09-10.
  ...
  adsets: [
    {
      ...
      ads: [
        {
          "adName": "AdventLaneRacing_NO_SP_2_1",
          "img": "AdventLaneRacing_NO_SP_2_1.jpg",
          "copy": {
    ...
    },
    {
      ...
      ads: [
        {
          "adName": "AdventLaneRacing_NO_G_2_1",
          "img": "AdventLaneRacing_NO_G_2_1.jpg",
          "copy": {
    ...
    },
    {
      ...
      ads: [
        {
          "adName": "AdventLaneRacing_NO_PD_2_1",
          "img": "AdventLaneRacing_NO_PD_2_1.jpg",
          "copy": {
