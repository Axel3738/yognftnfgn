...
const en = {
  ...
  group: {
    noCachedData: "no saved figures for the period — open that store's dashboard once",
...
const sv: Texts = {
  ...
  group: {
    noCachedData: "inga sparade siffror för perioden — öppna butikens panel en gång",
