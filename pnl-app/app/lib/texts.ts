...
const en = {
  ...
  costs: {
    market: {
      ...
      tableNote: "Bold = its own cost for that market. Grey with * = uses the standard cost. Pick a market above to edit it.",
...
const sv: Texts = {
  ...
  costs: {
    market: {
      ...
      tableNote: "Fet = egen kostnad för marknaden. Grå med * = använder standardkostnaden. Välj marknad ovan för att ändra.",
      inheritedPlaceholder: (v: string) => `${v} (standard)`,
