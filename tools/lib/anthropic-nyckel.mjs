...
/** Hjälptext när API:t svarar att nyckeln saknar workspace — i klartext, inte som rå 400. */
export const WORKSPACE_SAKNAS = `nyckeln är inte bunden till en workspace — skapa nyckeln inne i en workspace på console.anthropic.com, eller sätt ${WORKSPACE_NAMN} (wrkspc_…) i Environments`;
